    ...
    return (
        <div>
            <section  className='mx-[4%] my-4 md:mx-[8%] '>
                <h2 className='my-10 font-bold text-3xl md:text-center'>Alquiler de coches con conductor</h2>
                <div className='text-justify '>


                    <div className='md:grid grid-cols-2 gap-10 text-2xl'>
                    ...
                    <h3 className='my-8 font-semibold text-3xl text-left '>Alquiler de coches para eventos</h3>
                    <div className='md:grid grid-cols-2 gap-10'>
                        ...
                        <div className='md:flex justify-center items-center'>
                            <div className='border-4 border-[var(--secondary-color)] md:flex h-1/2 justify-center items-center'>
                                <p className='text-semibold text-3xl text-center p-4'>Contrate tu servicio con nosotros y despreocúpese</p>
                            </div>
                ...
                <div className='mx-8 p-10'>
                    ...
                    <div className='md:grid grid-cols-2 gap-5  '>
                        <div className='flex flex-col justify-center items-center md:mx-[8%]'>
                            <h2 className='font-semibold text-3xl'>Alquiler de coche para empresas con conductor</h2>
                            <p className='my-6 text-justify text-2xl'>Olvídese de la complicación de buscar coches de alquiler. Nosotros simplificamos su experiencia de transporte. Nuestra flota incluye vehículos espaciosos con capacidad de hasta 7 plazas, listos para adaptarse a cualquier requerimiento que tenga, asegurando comodidad y confort en todos sus viajes.</p>
                        ...
                        <div className='hidden md:block'>
                            <Image src="/furgoEspalda.webp" width={1200} height={700} alt='alquilerCoche' />
                        </div>
                    </div>
                </div>
            </section>
