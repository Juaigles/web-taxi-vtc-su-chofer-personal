    ...
    return (
        <div className='mx-[4%] md:mx-[8%]'>
            <section className='mb-10'>
                <article>
                    <h2 className='font-bold text-3xl my-10 md:mb-5 '>Su Chófer Personal - Nuestro servicio de VTC</h2>
                    <div className='text-justify md:grid md:grid-cols-2 md:gap-10 text-2xl'>
                ...
                <article>
                    <h2 className='font-bold text-3xl my-10 md:my-4'>¿Por qué elegir su servicio de taxi en Salamanca?</h2>
            ...
            <section>
                ...
                <Image src='/mercedes.webp' width={1280} height={900}  alt='mercedes' className='md:px-4' />
                </div>
